...
list.append(Agents([ 6 ,8.5], human_r,[-1,-1]))
list.append(Agents([ 2 ,5], human_r,[1,-1]))
...
while walker.position[1]<10:
    ...
    if(collision==false):
        ...
        print('prefer_angle1=', prefer_angle1*180/3.14)
    ...
    print('list[0]', list[0].position)
    print('list[1]', list[1].position)
